...
IFS=
sample_name=all_bacilli_histidine_decarboxylases
work_dir=data/${sample_name}
search_term="Bacilli[Orgn] AND histidine decarboxylase[Protein Name]"
reference_transporter_path=transporter_references/hdcP_reference_transporter_L.parabuchneri.fasta
