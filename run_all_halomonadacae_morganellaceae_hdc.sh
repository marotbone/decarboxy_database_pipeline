...
IFS=
sample_name=all_halomonadaceae_morganellaceae_histidine_decarboxylases
work_dir=data/${sample_name}
search_term="Morganellaceae [Organism] AND histidine decarboxylase[Protein Name] OR Halomonadaceae [Organism] AND histidine decarboxylase[Protein Name] "
