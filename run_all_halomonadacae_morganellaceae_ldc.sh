...
IFS=
sample_name=all_halomonadaceae_morganellaceae_lysine_decarboxylases
work_dir=data/${sample_name}
search_term="Morganellaceae [Organism] AND lysine decarboxylase[Protein Name] OR Halomonadaceae [Organism] AND lysine decarboxylase[Protein Name] "
