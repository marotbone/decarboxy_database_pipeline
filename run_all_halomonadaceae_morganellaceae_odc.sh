...
IFS=
sample_name=all_morganellaceae_halomonadaceae_ornithine_decarboxylases
work_dir=data/${sample_name}
search_term="Morganellaceae [Organism] AND ornithine decarboxylase[Protein Name] OR Halomonadaceae [Organism] AND ornithine decarboxylase[Protein Name] "
