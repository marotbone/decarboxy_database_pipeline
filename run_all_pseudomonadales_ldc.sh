...
IFS=
sample_name=all_pseudomonadales_lysine_decarboxylases
work_dir=data/${sample_name}
search_term="Pseudomonadales [Organism] AND lysine decarboxylase[Protein Name] "
